...
contract CounterScript is Script {
    ...
    function run() public returns (address factory, address router, address nativo, address multicallAddress, address token, address p1, address p2) {
        ...
        _router.addLiquidityETH{value: 1 ether}(
            address(usdc), 1 ether, 0, 0, ORIGIN, block.timestamp+ 60
        );
